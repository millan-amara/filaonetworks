  ...
  return (
    <div className='h-screen md:bg-black flex items-center justify-center'>
        ...
        <section className="md:text-white flex flex-col items-center text-center md:w-1/2">
          ...
          <a href={`https://wa.me/+254720973059`} target="_blank" rel="noopener noreferrer" className="bg-amber-600 font-bold text-white px-4 py-2 rounded-sm hover:bg-amber-700 z-50">Get a Free Quote</a>
        </section>
      </div>
  );
};
